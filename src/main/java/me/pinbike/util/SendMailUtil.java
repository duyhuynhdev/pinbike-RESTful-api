...
public class SendMailUtil {
    ...
    public static void sendPinBikeError(String[] mails, final int errorCode, String methodName, String inputObject, PinBikeException ex) {
        StringWriter errors = new StringWriter();
        ex.printStackTrace(new PrintWriter(errors));
        String mail_content = String.format(PinBikeConstant.MailLayout.error_mail, errorCode, errors.toString(), methodName, inputObject);
        for (String mail : mails) {
            try {
                new SendMailUtil(mail, "[ERROR] Method: "+methodName+" || Error code: "+errorCode, mail_content);
