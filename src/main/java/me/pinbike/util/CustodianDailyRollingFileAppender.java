...
/**
 * CustodianDailyRollingFileAppender.java Adapted from the Apache Log4j
 * DailyRollingFileAppender to extend the functionality of the existing class so
 * that the user can limit the number of log backups and compress the backups to
 * conserve disk space.
 *
 * @author Ryan Kimber
 *
